"""
Score an LST checkpoint over the test split, plot, and export rasters.

LST-defaulted alias for :mod:`experiments.infer_v4`. This one takes the
...
Usage
-----
    python -m experiments.infer_lst_v4 --ckpt ./_v4_ckpt_lst/dbwm_lst_gp_swiglu_v4.pkl \\
        --lst-dir /content/lst --weather-csv <csv> \\
        --export-geotiff --export-origins 20 --results-dir ./_v4_infer_lst
"""
from __future__ import annotations

from experiments._lst_entry import run_for_checkpoint
from experiments.infer_v4 import main as _main


def main() -> None:
    """Delegate to :func:`experiments.infer_v4.main`, checking the checkpoint."""
